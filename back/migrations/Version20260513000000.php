...
final class Version20260513000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE race_app (id INT UNSIGNED AUTO_INCREMENT NOT NULL, mode_id INT UNSIGNED NOT NULL, season_id INT UNSIGNED NOT NULL, time_id INT UNSIGNED NOT NULL, track_id INT UNSIGNED NOT NULL, race_order SMALLINT UNSIGNED DEFAULT NULL, finished TINYINT DEFAULT 0 NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DC653D35989D9B62 (slug), INDEX IDX_DC653D3577E5854A (mode_id), INDEX IDX_DC653D354EC001D1 (season_id), INDEX IDX_DC653D355EEADD3B (time_id), INDEX IDX_DC653D355ED23C43 (track_id), INDEX race_app_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE race_season (id INT UNSIGNED AUTO_INCREMENT NOT NULL, chapter SMALLINT UNSIGNED NOT NULL, name VARCHAR(64) NOT NULL, slug VARCHAR(128) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_9AB2457A5E237E06 (name), UNIQUE INDEX UNIQ_9AB2457A989D9B62 (slug), INDEX race_season_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        $this->addSql('CREATE TABLE race_time (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name SMALLINT UNSIGNED NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_32E9880A5E237E06 (name), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
