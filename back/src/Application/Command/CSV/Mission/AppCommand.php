...
use App\Infrastructure\Data\Mission\App;
...
#[AsCommand(
    name: 'asphalt:csv:mission:app',
    description: 'Toutes les données pour les Missions',
    aliases: ['asphalt-csv-mission-app'],
    hidden: false,
)]
class AppCommand extends Command
{
    ...
    private static string $file       = 'csv.file.mission.app';
    private static string $header     = 'csv.header.mission.app';
