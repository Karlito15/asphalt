...
use App\Infrastructure\Data\Mission\Task;
...
#[AsCommand(
    name: 'asphalt:csv:mission:task',
    description: 'Toutes les données pour les Tasks',
    aliases: ['asphalt-csv-mission-task'],
    hidden: false,
)]
class TaskCommand extends Command
{
    ...
    protected static string $title    = '::::: Mission Tasks Datas :::::';

    protected static string $help     = '';

    private static string $database   = 'csv.folders.database.datas';
    private static string $file       = 'csv.file.mission.task';
...
//        $logger     = $this->logger;
        ...
        if ($choice === 'import') {
            ...
            $io->newLine(2);
            $io->success("Les données pour les Task sont importées");
            $result = true;
        }
        ...
        if ($choice === 'export') {
            ...
            $io->newLine(2);
            $io->success("Les données pour les Task sont exportées");
            $result = true;
        }
