...
use App\Infrastructure\Data\Race\App;
...
#[AsCommand(
    name: 'asphalt:csv:race:app',
    description: "Toutes les données pour les Races",
    aliases: ['asphalt-csv-race-app'],
    hidden: false,
)]
class AppCommand extends Command
{
    ...
    private static string $file       = 'csv.file.race.app';
    private static string $header     = 'csv.header.race.app';
    ...
    private function import(string $folder, SymfonyStyle $io): void
    {
        ...
        if ($fs->exists($filepath)) {
            ...
            foreach ($records as $record) {
                ...
                ### Create Entity
                $entity = App::create($this->entityManager, $record);
