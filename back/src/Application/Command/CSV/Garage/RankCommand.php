...
#[AsCommand(
    name: 'asphalt:csv:garage:rank',
    description: "Toutes les données pour le Garage",
    aliases: ['asphalt-csv-garage-rank'],
    hidden: false,
)]
class RankCommand extends Command
{
    ...
    protected static string $title    = '::::: Garages Rank Datas :::::';

    protected static string $help     = '';

    private static string $database   = 'csv.folders.database.datas';
    private static string $file       = 'csv.file.garage.rank';
    private static string $header     = 'csv.header.garage.rank';
    ...
    private function import(string $folder, SymfonyStyle $io): void
    {
        ...
        if ($fs->exists($filepath)) {
            ...
            foreach ($records as $record) {
                ...
                ### Create Entity
                $entity = App::createRank($this->entityManager, $record);
