...
#[AsCommand(
    name: 'asphalt:csv:garage:upgrade',
    description: "Toutes les données pour le Garage",
    aliases: ['asphalt-csv-garage-upgrade'],
    hidden: false,
)]
class UpgradeCommand extends Command
{
    ...
    protected static string $title    = '::::: Garages Upgrade Datas :::::';

    protected static string $help     = '';

    private static string $database   = 'csv.folders.database.datas';
    private static string $file       = 'csv.file.garage.upgrade';
    private static string $header     = 'csv.header.garage.upgrade';
    ...
    private function import(string $folder, SymfonyStyle $io): void
    {
        ...
        if ($fs->exists($filepath)) {
            ...
            foreach ($records as $record) {
                ...
                ### Create Entity
                $entity = App::createUpgrade($this->entityManager, $record);
