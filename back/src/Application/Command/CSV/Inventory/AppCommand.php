...
namespace App\Application\Command\CSV\Inventory;
...
use App\Infrastructure\Data\Inventory\App;
...
class AppCommand extends Command
{
    ...
    private static string $file       = 'csv.file.inventory.app';
    private static string $header     = 'csv.header.inventory.app';
    private static string $folderName = 'inventories';
