...
class App
{
    ...
    public static function createBalanceAmount(EntityManagerInterface $entityManager, array $datas): GarageBalanceAmount
    {
        $garage = self::findGarage($datas, $entityManager);

        $entity = new GarageBalanceAmount();
        $entity->setGarage($garage);

        return $entity;
    }

    public static function createBalanceDue(EntityManagerInterface $entityManager, array $datas): GarageBalanceDue
    {
        $garage = self::findGarage($datas, $entityManager);

        $entity = new GarageBalanceDue();
        $entity->setGarage($garage);

        return $entity;
    }

    public static function createBalancePaid(EntityManagerInterface $entityManager, array $datas): GarageBalancePaid
    {
        $garage = self::findGarage($datas, $entityManager);

        $entity = new GarageBalancePaid();
        $entity->setGarage($garage);
     ...
     * @return void
     */
    private static function setterApp(GarageApp $entity, array $datas): void
    {
