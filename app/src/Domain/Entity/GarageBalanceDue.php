...
use App\Domain\Repository\GarageBalanceDueRepository;
...
#[ORM\Entity(repositoryClass: GarageBalanceDueRepository::class)]
#[ORM\Table(name: 'garage_balance_due')]
#[ORM\Index(name: 'garage_balance_due_idx', columns: ['id'])]
#[ORM\HasLifecycleCallbacks]
#[Gedmo\SoftDeleteable(fieldName: 'deletedAt', timeAware: false, hardDelete: true)]
class GarageBalanceDue
{
    ...
    #[ORM\OneToOne(targetEntity: GarageApp::class, inversedBy: 'due', cascade: ['persist'])]
