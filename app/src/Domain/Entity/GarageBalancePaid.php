...
use App\Domain\Repository\GarageBalancePaidRepository;
...
#[ORM\Entity(repositoryClass: GarageBalancePaidRepository::class)]
#[ORM\Table(name: 'garage_balance_paid')]
#[ORM\Index(name: 'garage_balance_paid_idx_idx', columns: ['id'])]
#[ORM\HasLifecycleCallbacks]
#[Gedmo\SoftDeleteable(fieldName: 'deletedAt', timeAware: false, hardDelete: true)]
class GarageBalancePaid
{
    ...
    #[ORM\OneToOne(targetEntity: GarageApp::class, inversedBy: 'paid', cascade: ['persist'])]
