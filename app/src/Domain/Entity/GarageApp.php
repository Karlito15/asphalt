...
class GarageApp
{
    ...
    #[ORM\Column(type: Types::SMALLINT, length: 1, nullable: false, options: ['unsigned' => true])]
    #[Groups(['index', 'migration'])]
    protected int $stars = 3;

    #[ORM\Column(type: Types::SMALLINT, length: 2, nullable: false, options: ['unsigned' => true])]
    #[Groups(['index', 'migration'])]
    ...
    #[ORM\OneToOne(targetEntity: GarageBalanceAmount::class, mappedBy: 'garage', cascade: ['persist'], orphanRemoval: true)]
    #[Groups(['index', 'migration'])]
    protected GarageBalanceAmount $amount;

    #[ORM\OneToOne(targetEntity: GarageBalanceDue::class, mappedBy: 'garage', cascade: ['persist'], orphanRemoval: true)]
    #[Groups(['index', 'migration'])]
    protected GarageBalanceDue $due;

    #[ORM\OneToOne(targetEntity: GarageBalancePaid::class, mappedBy: 'garage', cascade: ['persist'], orphanRemoval: true)]
    #[Groups(['index', 'migration'])]
    protected GarageBalancePaid $paid;
    ...
    #[ORM\ManyToOne(targetEntity: SettingBlueprint::class, cascade: ['persist'], fetch: 'EAGER', inversedBy: 'garage')]
    #[ORM\JoinColumn(name: 'setting_blueprint_id', referencedColumnName: 'id', unique: false, nullable: false)]
    #[Assert\Type(SettingBlueprint::class)]
    #[Groups(['index', 'migration'])]
    protected ?SettingBlueprint $settingBlueprint = null;

    #[ORM\ManyToOne(targetEntity: SettingBrand::class, cascade: ['persist'], fetch: 'EAGER', inversedBy: 'garage')]
    #[ORM\JoinColumn(name: 'setting_brand_id', referencedColumnName: 'id', unique: false, nullable: false)]
    #[Assert\Type(SettingBrand::class)]
    #[Groups(['index', 'migration'])]
    protected ?SettingBrand $settingBrand = null;

    #[ORM\ManyToOne(targetEntity: SettingClass::class, cascade: ['persist'], fetch: 'EAGER', inversedBy: 'garage')]
    #[ORM\JoinColumn(name: 'setting_class_id', referencedColumnName: 'id', unique: false, nullable: false)]
    #[Assert\Type(SettingClass::class)]
    #[Groups(['index', 'migration'])]
    protected ?SettingClass $settingClass = null;

    #[ORM\ManyToOne(targetEntity: SettingLevel::class, cascade: ['persist'], fetch: 'EAGER', inversedBy: 'garage')]
    #[ORM\JoinColumn(name: 'setting_level_id', referencedColumnName: 'id', unique: false, nullable: false)]
    #[Assert\Type(SettingLevel::class)]
    #[Groups(['index', 'migration'])]
    protected ?SettingLevel $settingLevel = null;

    #[ORM\ManyToOne(targetEntity: SettingUnitPrice::class, cascade: ['persist'], fetch: 'EAGER', inversedBy: 'garage')]
    #[ORM\JoinColumn(name: 'setting_unit_price_id', referencedColumnName: 'id', unique: false, nullable: false)]
    ...
    public function getAmount(): ?GarageBalanceAmount
    {
        return $this->amount;
    }

    public function setAmount(?GarageBalanceAmount $amount): static
    {
        // unset the owning side of the relation if necessary
        if ($amount === null && $this->amount !== null) {
            $this->amount->setGarage(null);
        }

        // set the owning side of the relation if necessary
        if ($amount !== null && $amount->getGarage() !== $this) {
            $amount->setGarage($this);
        }
    ...
    public function getDue(): ?GarageBalanceDue
    {
        return $this->due;
    }

    public function setDue(?GarageBalanceDue $due): static
    {
        // unset the owning side of the relation if necessary
        if ($due === null && $this->due !== null) {
            $this->due->setGarage(null);
        }

        // set the owning side of the relation if necessary
        if ($due !== null && $due->getGarage() !== $this) {
            $due->setGarage($this);
        }
    ...
    public function getPaid(): ?GarageBalancePaid
    {
        return $this->paid;
    }

    public function setPaid(?GarageBalancePaid $paid): static
    {
        // unset the owning side of the relation if necessary
        if ($paid === null && $this->paid !== null) {
            $this->paid->setGarage(null);
        }

        // set the owning side of the relation if necessary
        if ($paid !== null && $paid->getGarage() !== $this) {
            $paid->setGarage($this);
        }
