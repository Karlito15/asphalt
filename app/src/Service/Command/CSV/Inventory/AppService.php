...
namespace App\Service\Command\CSV\Inventory;
...
class AppService implements CSVInterface
{
    ...
    public function createEntity(array $datas): InventoryApp
    {
        ...
        $entity->setValue($this->convertStringToInteger($datas['Value']));
        ($datas['Filter'] != '') ? $entity->setFilter($datas['Filter']) : $entity->setFilter('---');
        $entity->setPosition($this->convertStringToInteger($datas['Position']));
