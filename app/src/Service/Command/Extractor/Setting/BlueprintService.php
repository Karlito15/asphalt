...
class BlueprintService implements ExtractorServiceInterface
{
    use ExtractorService;

    private static string $folder = 'setting';

    private static string $file = 'blueprint.yaml';
    ...
    public function extractDatas(): string
    {
        try {
            ...
            $datas = $em->getRepository(SettingBlueprint::class)->findAll();
