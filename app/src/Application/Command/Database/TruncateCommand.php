...
class TruncateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->truncateTable(GarageBalanceAmount::class, $io);
        $this->truncateTable(GarageBalanceDue::class, $io);
        $this->truncateTable(GarageBalancePaid::class, $io);
        ...
        $this->truncateTable(StatisticalGarage::class, $io);
        $this->truncateTable(StatisticalRace::class, $io);
