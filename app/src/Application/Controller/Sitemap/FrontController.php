...
use App\Application\Service\Cache\SitemapCache;
...
final class FrontController extends AbstractController
{
    ...
    public function front(Request $request, SitemapCache $service): Response
    {
        ### Headers
...
//            $urls[] = [
//                'loc' => $this->generateUrl('app.garage.read', [
//                    'id' => $garage['id'],
//                    'slug' => $garage['slug']
//                ]),
//            ];
//            $urls[] = [
//                'loc' => $this->generateUrl('app.garage.update', [
//                    'id' => $garage['id'],
//                    'slug' => $garage['slug']
//                ]),
//            ];
//            $urls[] = [
//                'loc' => $this->generateUrl('app.garage.delete', [
//                    'id' => $garage['id']
//                ]),
//            ];
//        }
