...
final class UnitPriceCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield IntegerField::new('level01');
        yield IntegerField::new('level02');
        yield IntegerField::new('level03');
