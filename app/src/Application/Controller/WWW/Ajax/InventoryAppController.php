...
namespace App\Application\Controller\WWW\Ajax;
...
final class InventoryAppController extends AbstractController
{
    ...
    /**
     * Met à jour l'entité InventoryApp
     *
    ...
    {
        // Flash Message
        $this->addFlash('danger', $this->getMessageNotFound());
     ...
     * @return string
     */
    private function getMessageNotFound(): string
    {
        return $this->translator->trans('notification.ajax.not-found');
    }
}
