...
use App\Domain\Form\Back\RaceRegionType;
...
final class RegionController extends AbstractController
{
    ...
    private static array $crud = [
      ...
      'read'   => null,
      'update' => 'admin.race.region.update',
      'delete' => 'admin.race.region.delete',
    ];
    ...
    public function index(Request $request, RaceRegionRepository $repository): Response
    {
        ...
        return $this->render('@App/theme-aero/contents/back/race/region.html.twig', [
