...
use App\Domain\Form\Back\SettingBlueprintType;
...
final class BlueprintController extends BaseController
{
    use WebController;
    ...
    private static array $crud = [
      ...
      'read'   => null,
      'update' => 'admin.setting.blueprint.update',
      'delete' => 'admin.setting.blueprint.delete',
    ];
    ...
    public function index(Request $request, SettingBlueprintRepository $repository): Response
    {
        ...
        return $this->render('@App/theme-aero/contents/back/setting/blueprint.html.twig', [
