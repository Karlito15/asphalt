...
final class TaskController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        MissionTaskRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), MissionTask::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), MissionTask::class, 'json', [
