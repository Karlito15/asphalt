...
#[Route(
    path: 'api/mission/type',
    name: 'api.mission.type.',
...
final class TypeController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        MissionTypeRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), MissionType::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), MissionType::class, 'json', [
