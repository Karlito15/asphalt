...
final class ClassController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        SettingClassRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), SettingClass::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), SettingClass::class, 'json', [
