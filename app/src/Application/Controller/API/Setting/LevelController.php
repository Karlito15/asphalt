...
final class LevelController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        SettingLevelRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), SettingLevel::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), SettingLevel::class, 'json', [
