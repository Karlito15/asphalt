...
final class BrandController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        SettingBrandRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), SettingBrand::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), SettingBrand::class, 'json', [
