...
final class UnitPriceController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        SettingUnitPriceRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), SettingUnitPrice::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), SettingUnitPrice::class, 'json', [
