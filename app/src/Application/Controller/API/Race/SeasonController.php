...
final class SeasonController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        RaceSeasonRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), RaceSeason::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), RaceSeason::class, 'json', [
