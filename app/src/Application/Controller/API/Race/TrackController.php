...
final class TrackController extends AbstractAPIController
{
    ...
    public function detail(
        int $id,
        RaceTrackRepository $repository
    ): JsonResponse
    {
        return $this->json(
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), RaceTrack::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), RaceTrack::class, 'json', [
