...
final class TimeController extends AbstractAPIController
{
    ...
    ): JsonResponse
    {
        ...
        $post = $serializer->deserialize($request->getContent(), RaceTime::class, 'json');
    ...
    {
        ### Récupère les données
        $serializer->deserialize($request->getContent(), RaceTime::class, 'json', [
