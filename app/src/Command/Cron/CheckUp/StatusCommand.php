...
#[AsCommand(
    name: 'asphalt:cron:checkup:status',
    description: 'Mets à jour le Statut de la Voiture',
    aliases: ['asphalt-cron-checkup-status'],
    hidden: false,
)]
class StatusCommand extends Command
{
    ...
    protected static string $help  = 'Mets à jour le Statut de la Voiture';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($garages as $garage) {
            // Event
            $this->dispatcher->dispatch(new StatusEvent($garage));
