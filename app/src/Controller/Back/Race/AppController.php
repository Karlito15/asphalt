...
#[Route(
    path: '/{_locale<%app.supported_locales%>}/admin/race',
    name: 'admin.race.',
...
final class AppController extends AbstractController
{
    ...
    {
        return $this->render('@App/back/race/app/index.html.twig', [
    ...
    public function create(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin.race.index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('@App/back/race/app/new.html.twig', [
            'race_app' => $raceApp,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('@App/back/race/app/show.html.twig', [
            'race_app' => $raceApp,
        ]);
    }
    ...
    public function update(Request $request, RaceApp $raceApp, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('@App/back/race/app/edit.html.twig', [
            'race_app' => $raceApp,
            'form' => $form,
        ]);
    }
