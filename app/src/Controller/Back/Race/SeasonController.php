...
#[Route('{_locale<%app.supported_locales%>}/admin/race/season', name: 'admin.race.season.', options: ['expose' => false], schemes: ['http', 'https'], format: 'html', utf8: true)]
final class SeasonController extends AbstractController
{
    use WebTrait;

    /** @description link to the index page */
    private static string $index    = 'admin.race.season.index';

    /** @description link to the create page */
    private static string $create   = 'admin.race.season.create';

    /** @description link to the delete page */
    private static string $delete   = 'admin.race.season.delete';
    ...
    public function index(Request $request, RaceSeasonRepository $repository): Response
    {
        ...
        return $this->render('@App/back/contents/race/season.html.twig', [
    ...
    {
        $title = $this->translator->trans('text.create.season');
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', [
                'title' => $this->translator->trans('text.season'),
        ...
        return $this->render('@App/back/contents/common/form.html.twig', [
            ...
            'current_page'      => $request->attributes->get('_route'),
            'container'       => 'container',
            'breadcrumb'        => ['level1' => $this->translator->trans('text.season'), 'level2' => $title],
            'links'             => self::getLinksPage(),
            'entities'          => $entities,
            'form'              => $form,
        ]);
    ...
    public function update(Request $request, RaceSeason $entities, EntityManagerInterface $manager): Response
    {
    ...
    public function delete(Request $request, RaceSeason $entities, EntityManagerInterface $manager): Response
    {
