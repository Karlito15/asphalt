...
use App\Persistence\Form\Back\RaceSeasonType;
...
final class SeasonController extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $manager): Response
    {
        // Variables
        $home  = $this->translator->trans('text.race');
        $page  = $this->translator->trans('text.season');
        $title = $this->translator->trans('text.create.season');
        $entity = new RaceSeason();
        $form = $this->createForm(RaceSeasonType::class, $entity)->handleRequest($request);
