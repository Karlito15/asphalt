...
#[Route('{_locale<%app.supported_locales%>}/admin/race/mode', name: 'admin.race.mode.', options: ['expose' => false], schemes: ['http', 'https'], format: 'html', utf8: true)]
final class ModeController extends AbstractController
{
    use WebTrait;

    /** @description link to the index page */
    private static string $index    = 'admin.race.mode.index';

    /** @description link to the create page */
    private static string $create   = 'admin.race.mode.create';

    /** @description link to the delete page */
    private static string $delete   = 'admin.race.mode.delete';
    ...
    public function index(Request $request, RaceModeRepository $repository): Response
    {
        ...
        return $this->render('@App/back/contents/race/mode.html.twig', [
    ...
    public function create(Request $request, EntityManagerInterface $manager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', [
                'title' => $this->translator->trans('text.mode'),
        ...
        return $this->render('@App/back/contents/common/form.html.twig', [
            ...
            'current_page'    => $request->attributes->get('_route'),
            'container'       => 'container',
            'breadcrumb'      => ['level1' => $this->translator->trans('text.mode'), 'level2' => $title],
            'links'           => self::getLinksPage(),
            'entities'        => $entities,
            'form'            => $form,
        ]);
