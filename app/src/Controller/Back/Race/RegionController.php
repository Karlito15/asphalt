...
#[Route('{_locale<%app.supported_locales%>}/admin/race/region', name: 'admin.race.region.', options: ['expose' => false], schemes: ['http', 'https'], format: 'html', utf8: true)]
final class RegionController extends AbstractController
{
    use WebTrait;

    /** @description link to the index page */
    private static string $index    = 'admin.race.region.index';

    /** @description link to the create page */
    private static string $create   = 'admin.race.region.create';

    /** @description link to the delete page */
    private static string $delete   = 'admin.race.region.delete';
    ...
    {
        $title = $this->translator->trans('text.all.regions');

        return $this->render('@App/back/contents/race/region.html.twig', [
    ...
    {
        $title = $this->translator->trans('text.create.region');
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', [
                'title' => $this->translator->trans('text.region'),
        ...
        return $this->render('@App/back/contents/common/form.html.twig', [
            ...
            'current_page'      => $request->attributes->get('_route'),
            'container'       => 'container',
            'breadcrumb'        => ['level1' => $this->translator->trans('text.region'), 'level2' => $title],
            'links'             => self::getLinksPage(),
            'entities'          => $entities,
            'form'              => $form,
        ]);
    ...
    public function update(Request $request, RaceRegion $entities, EntityManagerInterface $manager): Response
    {
    ...
    public function delete(Request $request, RaceRegion $entities, EntityManagerInterface $manager): Response
    {
