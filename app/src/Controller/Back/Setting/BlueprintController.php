...
#[Route('{_locale<%app.supported_locales%>}/admin/setting/blueprint', name: 'admin.setting.blueprint.', options: ['expose' => false], schemes: ['http', 'https'], format: 'html', utf8: true)]
final class BlueprintController extends AbstractController
{
    ...
    public function index(Request $request, SettingBlueprintRepository $repository): Response
    {
        ...
        return $this->render('@App/back/contents/setting/blueprint.html.twig', [
    ...
    public function create(Request $request, EntityManagerInterface $manager): Response
    {
        ...
        return $this->render('@App/back/contents/common/form.html.twig', [
            ...
            'current_page'      => $request->attributes->get('_route'),
            'container'       => 'container',
            'breadcrumb'        => ['level1' => $this->translator->trans('text.setting'), 'level2' => $this->translator->trans('text.blueprint')],
            'links'             => self::getLinksPage(),
            'entities'          => $entities,
            'form'              => $form,
        ]);
