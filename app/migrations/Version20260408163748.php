 ...
 */
final class Version20260408163748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE race_app (
        ...
        $this->addSql('CREATE TABLE race_mode (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE race_region (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE race_season (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE race_time (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE race_track (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL, region_id INT UNSIGNED DEFAULT NULL,
