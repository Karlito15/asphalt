 ...
 */
final class Version20260408163749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE setting_brand (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE setting_class (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE setting_tag (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql('CREATE TABLE setting_unit_price (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
