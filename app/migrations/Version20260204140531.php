 ...
 */
final class Version20260204140531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission_app (id INT UNSIGNED AUTO_INCREMENT NOT NULL, week SMALLINT UNSIGNED DEFAULT 1 NOT NULL, region VARCHAR(64) DEFAULT NULL, track VARCHAR(64) DEFAULT NULL, class VARCHAR(16) DEFAULT NULL, brand VARCHAR(64) DEFAULT NULL, description VARCHAR(32) DEFAULT NULL, success SMALLINT UNSIGNED DEFAULT 0 NOT NULL, target SMALLINT UNSIGNED DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, task_id INT UNSIGNED NOT NULL, type_id INT UNSIGNED NOT NULL, INDEX IDX_520BE7B68DB60186 (task_id), INDEX IDX_520BE7B6C54C8C93 (type_id), INDEX mission_app_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE mission_task (id INT UNSIGNED AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, value VARCHAR(64) NOT NULL, slug VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_7B3C772A1D775834 (value), UNIQUE INDEX UNIQ_7B3C772A989D9B62 (slug), INDEX mission_task_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE mission_type (id INT UNSIGNED AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, value VARCHAR(64) NOT NULL, slug VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_A59CFB261D775834 (value), UNIQUE INDEX UNIQ_A59CFB26989D9B62 (slug), INDEX mission_type_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
