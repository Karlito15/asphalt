...
final class Version20260515000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_balance_amount (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              level01 INT UNSIGNED DEFAULT NULL,
              level02 INT UNSIGNED DEFAULT NULL,
              level03 INT UNSIGNED DEFAULT NULL,
              level04 INT UNSIGNED DEFAULT NULL,
              level05 INT UNSIGNED DEFAULT NULL,
              level06 INT UNSIGNED DEFAULT NULL,
              level07 INT UNSIGNED DEFAULT NULL,
              level08 INT UNSIGNED DEFAULT NULL,
              level09 INT UNSIGNED DEFAULT NULL,
              level10 INT UNSIGNED DEFAULT NULL,
              level11 INT UNSIGNED DEFAULT NULL,
              level12 INT UNSIGNED DEFAULT NULL,
              level13 INT UNSIGNED DEFAULT NULL,
              common INT UNSIGNED DEFAULT NULL,
              rare INT UNSIGNED DEFAULT NULL,
              epic INT UNSIGNED DEFAULT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_15D52A40C4FFF555 (garage_id),
              INDEX garage_balance_amount_idx_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_balance_due (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              level01 INT UNSIGNED DEFAULT NULL,
              level02 INT UNSIGNED DEFAULT NULL,
              ...
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_A50D54A3C4FFF555 (garage_id),
              INDEX garage_balance_due_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_balance_paid (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              level01 INT UNSIGNED DEFAULT NULL,
              level02 INT UNSIGNED DEFAULT NULL,
              ...
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_BF4631A2C4FFF555 (garage_id),
              INDEX garage_balance_paid_idx_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garage_balance_amount DROP FOREIGN KEY FK_15D52A40C4FFF555');
        $this->addSql('ALTER TABLE garage_balance_due DROP FOREIGN KEY FK_A50D54A3C4FFF555');
        $this->addSql('ALTER TABLE garage_balance_paid DROP FOREIGN KEY FK_BF4631A2C4FFF555');
        ...
        $this->addSql('DROP TABLE garage_balance_amount');
        $this->addSql('DROP TABLE garage_balance_due');
        $this->addSql('DROP TABLE garage_balance_paid');
