 ...
 */
final class Version20260204180233 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Garages & Settings Table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE garage_app (id INT UNSIGNED AUTO_INCREMENT NOT NULL, stars SMALLINT UNSIGNED DEFAULT 3 NOT NULL, game_update SMALLINT UNSIGNED DEFAULT 0 NOT NULL, car_order SMALLINT UNSIGNED DEFAULT 99 NOT NULL, stat_order SMALLINT UNSIGNED DEFAULT 99 NOT NULL, level SMALLINT UNSIGNED DEFAULT 0 NOT NULL, epic SMALLINT UNSIGNED DEFAULT 0 NOT NULL, model VARCHAR(128) NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, setting_blueprint_id INT UNSIGNED DEFAULT NULL, setting_brand_id INT UNSIGNED DEFAULT NULL, setting_class_id INT UNSIGNED DEFAULT NULL, setting_level_id INT UNSIGNED DEFAULT NULL, setting_unit_price_id INT UNSIGNED DEFAULT NULL, UNIQUE INDEX UNIQ_B97F42D2989D9B62 (slug), INDEX IDX_B97F42D25869B9F3 (setting_blueprint_id), INDEX IDX_B97F42D2EA7CE8F2 (setting_brand_id), INDEX IDX_B97F42D2448933EA (setting_class_id), INDEX IDX_B97F42D2F138735D (setting_level_id), INDEX IDX_B97F42D24A5104AF (setting_unit_price_id), INDEX garage_app_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_blueprint (id INT UNSIGNED AUTO_INCREMENT NOT NULL, star1 VARCHAR(8) DEFAULT NULL, star2 SMALLINT UNSIGNED DEFAULT NULL, star3 SMALLINT UNSIGNED DEFAULT NULL, star4 SMALLINT UNSIGNED DEFAULT NULL, star5 SMALLINT UNSIGNED DEFAULT NULL, star6 SMALLINT UNSIGNED DEFAULT NULL, total SMALLINT UNSIGNED DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_FEB8406FC4FFF555 (garage_id), INDEX garage_blueprint_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_evo (id INT UNSIGNED AUTO_INCREMENT NOT NULL, number SMALLINT UNSIGNED DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_6524407DC4FFF555 (garage_id), INDEX garage_evo_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_gauntlet (id INT UNSIGNED AUTO_INCREMENT NOT NULL, speed SMALLINT UNSIGNED DEFAULT 9, acceleration SMALLINT UNSIGNED DEFAULT 9, handling SMALLINT UNSIGNED DEFAULT 9, nitro SMALLINT UNSIGNED DEFAULT 9, mark SMALLINT UNSIGNED DEFAULT 9, division SMALLINT UNSIGNED DEFAULT 9, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_F5DB9824C4FFF555 (garage_id), INDEX garage_gauntlet_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_rank (id INT UNSIGNED AUTO_INCREMENT NOT NULL, star0 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star1 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star2 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star3 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star4 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star5 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, star6 SMALLINT UNSIGNED DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_EB0F950EC4FFF555 (garage_id), INDEX garage_rank_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_stat_actual (id INT UNSIGNED AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, speed DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, acceleration DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, handling DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, nitro DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, average DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_3FDFA9D8C4FFF555 (garage_id), INDEX garage_stat_actual_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_stat_max (id INT UNSIGNED AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, speed DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, acceleration DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, handling DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, nitro DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, average DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_91F01015C4FFF555 (garage_id), INDEX garage_stat_max_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_stat_min (id INT UNSIGNED AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, speed DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, acceleration DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, handling DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, nitro DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, average DOUBLE PRECISION UNSIGNED DEFAULT 0 NOT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_ADFD2F4CC4FFF555 (garage_id), INDEX garage_stat_min_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_status (id INT UNSIGNED AUTO_INCREMENT NOT NULL, evo TINYINT DEFAULT 0 NOT NULL, unblock TINYINT DEFAULT 0 NOT NULL, to_unblock TINYINT DEFAULT 0 NOT NULL, gold TINYINT DEFAULT 0 NOT NULL, to_gold TINYINT DEFAULT 0 NOT NULL, full_upgrade_level TINYINT DEFAULT 0 NOT NULL, to_upgrade_level TINYINT DEFAULT 0 NOT NULL, full_blueprint_star1 TINYINT DEFAULT 0 NOT NULL, full_blueprint_star2 TINYINT DEFAULT 0 NOT NULL, full_blueprint_star3 TINYINT DEFAULT 0 NOT NULL, full_blueprint_star4 TINYINT DEFAULT 0 NOT NULL, full_blueprint_star5 TINYINT DEFAULT 0 NOT NULL, full_blueprint_star6 TINYINT DEFAULT 0 NOT NULL, full_upgrade_speed TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_speed TINYINT DEFAULT 0 NOT NULL, full_upgrade_acceleration TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_acceleration TINYINT DEFAULT 0 NOT NULL, full_upgrade_handling TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_handling TINYINT DEFAULT 0 NOT NULL, full_upgrade_nitro TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_nitro TINYINT DEFAULT 0 NOT NULL, full_upgrade_common TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_common TINYINT DEFAULT 0 NOT NULL, full_upgrade_rare TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_rare TINYINT DEFAULT 0 NOT NULL, full_upgrade_epic TINYINT DEFAULT 0 NOT NULL, to_install_upgrade_epic TINYINT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_E83E21CCC4FFF555 (garage_id), INDEX garage_status_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE garage_upgrade (id INT UNSIGNED AUTO_INCREMENT NOT NULL, speed SMALLINT UNSIGNED DEFAULT 0 NOT NULL, acceleration SMALLINT UNSIGNED DEFAULT 0 NOT NULL, handling SMALLINT UNSIGNED DEFAULT 0 NOT NULL, nitro SMALLINT UNSIGNED DEFAULT 0 NOT NULL, common SMALLINT UNSIGNED DEFAULT 0 NOT NULL, rare SMALLINT UNSIGNED DEFAULT 0 NOT NULL, epic SMALLINT UNSIGNED DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, garage_id INT UNSIGNED DEFAULT NULL, INDEX IDX_3126988AC4FFF555 (garage_id), INDEX garage_upgrade_idx (id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE setting_tag (id INT UNSIGNED AUTO_INCREMENT NOT NULL, value VARCHAR(64) NOT NULL, cars_number SMALLINT UNSIGNED DEFAULT 0 NOT NULL, slug VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D6B8FABD989D9B62 (slug), INDEX setting_tag_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE setting_tag_garage_app (setting_tag_id INT UNSIGNED NOT NULL, garage_app_id INT UNSIGNED NOT NULL, INDEX IDX_7A8B8060802E9A2C (setting_tag_id), INDEX IDX_7A8B8060EAB965FD (garage_app_id), PRIMARY KEY (setting_tag_id, garage_app_id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE garage_evo ADD CONSTRAINT FK_6524407DC4FFF555 FOREIGN KEY (garage_id) REFERENCES garage_app (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garage_evo DROP FOREIGN KEY FK_6524407DC4FFF555');
        ...
        $this->addSql('DROP TABLE garage_evo');
