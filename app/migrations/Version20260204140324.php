 ...
 */
final class Version20260204140324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE race_app (id INT UNSIGNED AUTO_INCREMENT NOT NULL, race_order SMALLINT UNSIGNED DEFAULT 0, finished TINYINT DEFAULT 0 NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, mode_id INT UNSIGNED NOT NULL, season_id INT UNSIGNED NOT NULL, time_id INT UNSIGNED NOT NULL, track_id INT UNSIGNED NOT NULL, UNIQUE INDEX UNIQ_DC653D35989D9B62 (slug), INDEX IDX_DC653D3577E5854A (mode_id), INDEX IDX_DC653D354EC001D1 (season_id), INDEX IDX_DC653D355EEADD3B (time_id), INDEX IDX_DC653D355ED23C43 (track_id), INDEX race_app_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE race_track (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name_english VARCHAR(64) NOT NULL, name_french VARCHAR(64) DEFAULT NULL, slug VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, region_id INT UNSIGNED DEFAULT NULL, UNIQUE INDEX UNIQ_30DDD9B724E847BE (name_english), UNIQUE INDEX UNIQ_30DDD9B7989D9B62 (slug), INDEX IDX_30DDD9B798260155 (region_id), INDEX race_track_idx (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
