 ...
 */
final class Version20260220175950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_blueprint_state (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              star1 VARCHAR(3) DEFAULT NULL,
              star2 SMALLINT UNSIGNED DEFAULT 0,
              star3 SMALLINT UNSIGNED DEFAULT 0,
              ...
              star6 SMALLINT UNSIGNED DEFAULT 0,
              total SMALLINT UNSIGNED DEFAULT 0,
              full_blueprint_star1 TINYINT DEFAULT 0 NOT NULL,
              full_blueprint_star2 TINYINT DEFAULT 0 NOT NULL,
              full_blueprint_star3 TINYINT DEFAULT 0 NOT NULL,
              full_blueprint_star4 TINYINT DEFAULT 0 NOT NULL,
              full_blueprint_star5 TINYINT DEFAULT 0 NOT NULL,
              full_blueprint_star6 TINYINT DEFAULT 0 NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_EF66E30EC4FFF555 (garage_id),
              INDEX garage_blueprint_state_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_evo (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              number SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_6524407DC4FFF555 (garage_id),
              INDEX garage_evo_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_evo_state (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              `all` TINYINT DEFAULT 0 NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_A7A84993C4FFF555 (garage_id),
              INDEX garage_evo_state_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_status (
              ...
              to_unblock TINYINT DEFAULT 0 NOT NULL,
              to_gold TINYINT DEFAULT 0 NOT NULL,
              full_upgrade_level TINYINT DEFAULT 0 NOT NULL,
              to_upgrade_level TINYINT DEFAULT 0 NOT NULL,
              garage_id INT UNSIGNED DEFAULT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garage_upgrade_state (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              speed SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              acceleration SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              handling SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              ...
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
              UNIQUE INDEX UNIQ_D7061A4DC4FFF555 (garage_id),
              INDEX garage_upgrade_state_idx (id),
              PRIMARY KEY (id)
            ) DEFAULT CHARACTER SET utf8
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE setting_brand (
              ...
              cars_number SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              slug VARCHAR(64) NOT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE setting_class (
              ...
              class_order SMALLINT UNSIGNED DEFAULT 1 NOT NULL,
              cars_number SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              median SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE setting_level (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              level SMALLINT UNSIGNED DEFAULT 10 NOT NULL,
              common SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              rare SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
              epic SMALLINT UNSIGNED DEFAULT 0 NOT NULL,
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE setting_unit_price (
              id INT UNSIGNED AUTO_INCREMENT NOT NULL,
              level01 INT UNSIGNED DEFAULT 0 NOT NULL,
              level02 INT UNSIGNED DEFAULT 0 NOT NULL,
              level03 INT UNSIGNED DEFAULT 0 NOT NULL,
              level04 INT UNSIGNED DEFAULT 0 NOT NULL,
              level05 INT UNSIGNED DEFAULT 0 NOT NULL,
              level06 INT UNSIGNED DEFAULT 0 NOT NULL,
              level07 INT UNSIGNED DEFAULT 0 NOT NULL,
              level08 INT UNSIGNED DEFAULT 0 NOT NULL,
              level09 INT UNSIGNED DEFAULT 0 NOT NULL,
              level10 INT UNSIGNED DEFAULT 0 NOT NULL,
              level11 INT UNSIGNED DEFAULT 0,
              level12 INT UNSIGNED DEFAULT 0,
              level13 INT UNSIGNED DEFAULT 0,
              common INT UNSIGNED DEFAULT 0 NOT NULL,
              rare INT UNSIGNED DEFAULT 0 NOT NULL,
              epic INT UNSIGNED DEFAULT 0,
              slug VARCHAR(128) NOT NULL,
              created_at DATETIME NOT NULL,
              updated_at DATETIME NOT NULL,
              deleted_at DATETIME DEFAULT NULL,
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_blueprint_state
            ADD
              CONSTRAINT FK_EF66E30EC4FFF555 FOREIGN KEY (garage_id) REFERENCES garage_app (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_evo
            ADD
              CONSTRAINT FK_6524407DC4FFF555 FOREIGN KEY (garage_id) REFERENCES garage_app (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_evo_state
            ADD
              CONSTRAINT FK_A7A84993C4FFF555 FOREIGN KEY (garage_id) REFERENCES garage_app (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_gauntlet
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_upgrade_state
            ADD
              CONSTRAINT FK_D7061A4DC4FFF555 FOREIGN KEY (garage_id) REFERENCES garage_app (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage_stat_actual
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garage_blueprint_state DROP FOREIGN KEY FK_EF66E30EC4FFF555');
        $this->addSql('ALTER TABLE garage_evo DROP FOREIGN KEY FK_6524407DC4FFF555');
        $this->addSql('ALTER TABLE garage_evo_state DROP FOREIGN KEY FK_A7A84993C4FFF555');
        ...
        $this->addSql('ALTER TABLE garage_upgrade_state DROP FOREIGN KEY FK_D7061A4DC4FFF555');
        $this->addSql('DROP TABLE garage_app');
        $this->addSql('DROP TABLE garage_blueprint');
        $this->addSql('DROP TABLE garage_blueprint_state');
        $this->addSql('DROP TABLE garage_evo');
        $this->addSql('DROP TABLE garage_evo_state');
        ...
        $this->addSql('DROP TABLE garage_upgrade_state');
