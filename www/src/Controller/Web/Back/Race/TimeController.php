...
final class TimeController extends AbstractController
{
    ...
    {
        $title = $this->translator->trans('app.race.time.create.title');
    ...
    public function update(Request $request, RaceTime $entities, EntityManagerInterface $entityManager): Response
    {
        $title = $this->translator->trans('app.race.time.update.title');
        $form = $this->createForm(RaceTimeType::class, $entities)->handleRequest($request);
    ...
    public function delete(Request $request, RaceTime $entities, EntityManagerInterface $entityManager): Response
    {
