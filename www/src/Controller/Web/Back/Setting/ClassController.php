...
final class ClassController extends AbstractController
{
    ...
    public function index(Request $request, SettingClassRepository $repository): Response
    {
        ...
        return $this->render('@App/contents/back/setting/class/index.html.twig', [
    ...
    public function create(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('@App/contents/back/setting/class/form.html.twig', [
            'controller_name'   => $title,
            'current_page'      => $request->attributes->get('_route'),
            'breadcrumb'        => ['level1' => $this->translator->trans('app.setting.class.index.title'), 'level2' => $title],
            'links'             => self::getLinksPage(),
            'entities'          => $entities,
            'form'              => $form,
        ]);
