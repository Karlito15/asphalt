...
class RankService implements ServiceInterface
{
    use ServiceAble;
    use CommandAble;
    ...
    public function export(SymfonyStyle $io): void
    {
        ...
        try {
            ...
            // Insert each line
            $csv->insertOne(['Star0', 'Star1', 'Star2', 'Star3', 'Star4', 'Star5', 'Star6', 'Brand', 'Model']);
            foreach ($rows as $row) {
                $csv->insertOne([
                    $row->getStar0(), $row->getStar1(), $row->getStar2(), $row->getStar3(), $row->getStar4(), $row->getStar5(), $row->getStar6(),
    ...
    public function getCSVFile(): string
    {
        ...
        return $d. (($e === 'dev') ? 'dev--rank.csv' : 'rank.csv');
    }
}
