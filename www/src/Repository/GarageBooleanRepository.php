...
class GarageBooleanRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, GarageBoolean::class);
    }
    ...
    /**
     * @param GarageBoolean $entity
     * @param bool $flush
     * @return void
     */
    public function save(GarageBoolean $entity, bool $flush = false): void
    {
     ...
     * @return void
     */
    public function remove(GarageBoolean $entity, bool $flush = false): void
    {
