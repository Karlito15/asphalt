...
DATABASE_SERVER_VERSION=11.4.9-MariaDB
DATABASE_URL="mysql://${DATABASE_USER}:${DATABASE_PASS}@127.0.0.1:${DATABASE_PORT}/${DATABASE_NAME}?serverVersion=${DATABASE_SERVER_VERSION}"
###< doctrine/doctrine-bundle ###
